...
{
    public partial class InMemoryMessageBrokerSubscriptionsManager : IMessageBrokerSubscriptionsManager
    {
        ...
        public InMemoryMessageBrokerSubscriptionsManager()
        {
        ...
        public IEnumerable<SubscriptionInfo> GetHandlersForMessage<T>() where T : Message
        {
